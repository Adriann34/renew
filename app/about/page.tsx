const sections = [
  {
    ...
    title: "About",
    body: [
      "Renew is a marketplace for buying and selling used PC hardware — GPUs, CPUs, and everything around them. Instead of relying on stock photos or seller claims, every listing carries a diagnostic report: condition grade, benchmark score, and tested power draw, generated by our bench-testing process.",
